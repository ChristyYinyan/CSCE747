...
public class CourseStats {
	...
	public static void main(String[] args) {
		...
		WeekTime a = new WeekTime("T", "09:10", "am");
		WeekTime b = new WeekTime("T", "11:10", "am");
		Course c = new Course("CSCE", 110, "MatthewsA", a, b);
		...
		String filename = "/Users/yinyanhe/Desktop/CSCE747/Test1/edu.sc.cse.coursestats/data/sched.csv";
		File infile = null;
		try{
